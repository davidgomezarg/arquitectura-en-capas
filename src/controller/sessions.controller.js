...
class SessionsController{
    ...
    static login = async (req,res)=>{
        ...
        if(!req.user){//Para que quiero este IF si tengo el failureRedirect del passport? Si se llega a esta instancia, es porque existe el usuario en la base de datos.... mmmm
